...
botStart = time.time()
settings = {
    "line": "ExvOnvPNm2ccJWmZBY02.UIF1+mlIZg/2BbkXn0ysiG.v0bC0jKISuWv2LOj3oJxou8xe/ayukXOumXY0nA34Jk=",
    "pb1": "Exk9VxDd9u53RBY4MFq2.ZlRAr2yfgbD49WB0dBNQWG.s6IjobPVJuyVlfaiRZgaVXsRlktVTFYP29dYriU8B5o=",
    "pb2": "ExqJcwoc4mSMNzY9c950.4W8wzZWa2CIx12clXmI9Ga.pS/UJkgXbuMGPxNQwojME3CHgAiesrHGMXUC6g+jkac=",
    "kunci": False,
    "kata": "prank",
    "blacklist": {}
}
...
Bots = [myBOG,pb1BOG,pb2BOG,"uba27f5fcc2e2cc6fb66c12b137461222"]
settings = {
    "kunci": False,
    "kata": "prank",
    "blacklist": {}
